...
A variable contains the name (as found on the source file), a type (type_integer,type real,..)  */
...
// Since this needs to change the symbol_table pass a pointer (i.e. addvar(&symbolTable, ... )).
